...
import { SignoPacienteNuevoComponent } from './signos/signos-edicion/signo-paciente-nuevo/signo-paciente-nuevo.component';
...
export const routes: Routes = [
    ...
    { path: 'signos', component: SignosComponent, children:[
      ...
      { path: 'edicion/:id', component: SignosEdicionComponent, children:[
        {path: 'signo-paciente-nuevo', component: SignoPacienteNuevoComponent}
      ] }
    ], canActivate:[GuardService] },
]
